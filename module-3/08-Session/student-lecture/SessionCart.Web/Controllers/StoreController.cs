    ...
    public class StoreController : Controller
    {
        ...
        */
        ...
        private List<int> AddToList(int productId)
        {
            ...
            List<int> current = HttpContext.Session.Get<List<int>>("ShoppingCart"); //Get from session the list of int that is shopping cart

            if (current == null) //if it is null I set it to the empty lit I created above 
            {
            ...
            HttpContext.Session.Set<List<int>>("ShoppingCart", current); //Last thing I do before I return is I put the value of product Id into session
