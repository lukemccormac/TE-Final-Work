...
namespace Exercises
{
    public partial class Exercises
    {
        ...
        public double IsItOnSale(string itemNumber)
        {
            ...
            itemList["KITCHEN4001"] = 0.20;
            itemList["GARAGE1070"] = 0.15;
            itemList["LIVINGROOM"] = 0.10;
            itemList["KITCHEN6073"] = 0.40;
            itemList["BEDROOM3434"] = 0.60;
            itemList["BATH0073"] = 0.15;
            itemList[""] = 0.00;

            // Now check the Dictionary you just created for the itemNumber
            if (itemList.ContainsKey(itemNumber.ToUpper()))
            {
                return itemList[itemNumber.ToUpper()];
            }
            else
            {
                return 0.00;
