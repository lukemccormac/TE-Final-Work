...
{
    public class MockRecipeDAO : IRecipeDAO
    {
        /// <summary>
        ...
        {
            return GetRecipes().FirstOrDefault(r => r.Id == id);
        }
        ...
        public IList<Recipe> GetRecipes()
        {
            Recipe chiliGarlic = new Recipe()
            {
                ...
                ImageName = "roasted-chili-broccoli.jpg",
            ...
            Recipe mexicanRicePilaf = new Recipe()
            {
                ...
                ImageName = "mexican-rice-pilaf.jpg",
            ...
            {
                chiliGarlic, pasta, mexicanRicePilaf
            };
        }
