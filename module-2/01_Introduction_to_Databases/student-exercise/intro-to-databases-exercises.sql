...
SELECT name, region 
FROM country
WHERE region = 'North America' OR region = 'South America' OR region = 'Central America'
...
SELECT ((gnp*1000000) / population) AS percapitagnp
FROM country
WHERE continent = 'EUROPE'
...
SELECT (2019-indepyear) AS yearsofindependence
FROM country
