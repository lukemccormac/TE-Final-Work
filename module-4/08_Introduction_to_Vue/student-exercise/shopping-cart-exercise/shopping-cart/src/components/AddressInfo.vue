      ...
      <div class="col-8">
        <form>
          ...
          <div class="form-group">
            ...
            <input v-model="shipping.address2" 
              type="text"
              class="form-control"
              id="shippingAddress2"
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input  v-model="shipping.city"  type="text" class="form-control" id="shippingCity">
            </div>
            ...
            <div class="form-group col-md-2">
              ...
              <input v-model="shipping.zip" type="text" class="form-control" id="shippingZip">
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-4">
          ...
          <div class="billing-add" v-if="!billingSameAsShipping">
            ...
            <div class="form-group">
              ...
              <input v-model="billing.address2"
                type="text"
                class="form-control"
                id="billingAddress2"
                placeholder="Apartment, studio, or floor"
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-2">
                ...
                <input v-model="billing.zip" type="text" class="form-control" id="billingZip">
              </div>
            </div>
          </div>
